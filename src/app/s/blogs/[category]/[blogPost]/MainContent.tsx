                ...
                {blogLoading ? (
                  ...
                  <>
                    ...
                    <figure>
                      ...
                      <p className="text-sm font-medium text-center mt-3 mb-10 text-gray-500">
                    ...
                    <section
                      id="blogContent"
                      className="my-10 space-y-5 md:space-y-8 text-ellipsis overflow-x-auto pb-5 blogContent"
                    >
                      {data && (
                        <div
