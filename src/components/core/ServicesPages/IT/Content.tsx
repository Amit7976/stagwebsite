              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <p className="text-base md:text-xl lg:font-medium text-muted-foreground">
                    In today’s digital-first world, a business without a strong
                    online presence is like a store without an entrance. Website
                    & Web App Development Services refer to the complete process
                    of designing, developing, and deploying websites and
                    web-based applications that are tailored to meet the
                    specific needs of businesses, organizations, and
                    individuals.
                  </p>
                  <p className="text-base md:text-xl lg:font-medium text-muted-foreground">
                    A website is often the first touchpoint for potential
                    customers—it showcases your brand, products, and services. A
                    web application, on the other hand, is an interactive
                    platform built to perform specific functions, such as
                    e-commerce portals, booking systems, dashboards, CRMs, or
                    custom tools.
                  </p>
                  <p className="text-base md:text-xl lg:font-medium text-muted-foreground">
