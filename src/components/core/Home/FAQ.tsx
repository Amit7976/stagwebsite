      ...
      <div className="container space-y-16">
        ...
        <div className="mx-auto flex max-w-6xl flex-col items-center rounded-lg bg-accent dark:bg-neutral-900 p-4 text-center md:rounded-xl md:p-6 lg:p-8">
          ...
          <div className="flex w-full flex-col justify-center gap-2 sm:flex-row">
            <Button className="w-full sm:w-auto text-orange-600 border-2 border-orange-600 bg-transparent hover:bg-orange-600 hover:text-white hover:border-orange-700 duration-300 h-11 rounded-full px-10" asChild>
              <a href={faqsButtonUrl} target="_blank">
                {faqsButtonText}
              </a>
            </Button>
            <Button className="w-full sm:w-auto text-white bg-orange-600 h-11 rounded-full px-8" asChild>
