    ...
    <>
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:pt-20 lg:pb-10 mx-auto">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="group relative flex flex-col w-full min-h-60 bg-center bg-cover rounded-xl hover:shadow-lg transition border-2 overflow-hidden">
            ...
            <div className="flex flex-col px-5 py-6 gap-2 col-span-2">
              ...
              <p className="text-sm font-medium my-2 text-gray-400">
                From custom websites to robust apps, we design, build, and
                maintain digital solutions that help your business grow -
                stress-free.
              </p>
              <div className="flex gap-2 items-center flex-wrap select-none">
                <Link
                  href={"/"}
                  className="px-4 py-2 mt-5 text-sm font-semibold text-white bg-[#FE4A03] hover:bg-orange-700 rounded-full flex items-center gap-2"
                >
