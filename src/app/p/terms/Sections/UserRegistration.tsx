      ...
      <div className="p-10 space-y-10">
        ...
        <div className="space-y-6">
          ...
          <p>
            ...
            Registration grants users access to various features of the JobBoost
            platform, including job searches, application processes, and job
            postings. It is essential to understand and comply with the
            registration terms to ensure a smooth experience on JobBoost.
          </p>
        </div>
        <div className="space-y-6">
          <h4 className="font-bold text-2xl text-gray-800 mt-12">
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              candidate account that allows you to search for job opportunities,
              apply for positions, and manage your career profile. The steps
              involved in the candidate registration process are as follows:
            </p>

            <ul className="list-disc px-10 space-y-4">
              <li>
                <b>Access the Registration Page:</b> Visit the JobBoost website
                and navigate to the candidate registration page. This page can
                be accessed from the home page or the &#34;Sign Up&#34; section.
              </li>
              <li>
              ...
              <li>
                ...
                Conditions and Privacy Policy. This agreement confirms that you
                understand and agree to the rules and practices governing the
                use of the platform.
              </li>
              <li>
                <b>Verification:</b> After submitting your registration details,
                you will receive a verification email or SMS. Follow the
                instructions in the email or SMS to verify your account. This
                step is crucial to activate your account and start using
                JobBoost’s features.
              </li>
            </ul>
          </div>
          <div className="space-y-6">
            ...
            <ul className="list-disc px-10 space-y-4">
              <li>
                ...
                information provided during registration is truthful, accurate,
                and complete. Misrepresentations can lead to account suspension
                or termination.
              </li>
              <li>
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              basic job search features. By paying this fee, you gain access to:
            </p>

            <ul className="list-disc px-10 space-y-4">
              <li>
                <b>Job Search Tools:</b> Access to search for job opportunities
                based on various filters such as location, industry, and job
                type.
              </li>
              <li>
              ...
              <li>
                ...
                track job opportunities, and receive notifications about new job
                listings.
              </li>
            </ul>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <ul className="list-disc px-10 space-y-4">
              ...
              <li>
                ...
                password for your employer account. Ensure that your password is
                secure and different from passwords used on other sites.
              </li>
              <li>
              ...
              <li>
                ...
                JobBoost Terms and Conditions and Privacy Policy. This agreement
                signifies that you understand and agree to JobBoost’s rules and
                practices.
              </li>
              <li>
                <b>Verification:</b> After registration and payment, you will
                receive a verification email. Follow the instructions to verify
                your company’s account and complete the registration process.
              </li>
            </ul>
          </div>
          <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <p>
              To create a company account, a one-time registration fee of ₹99 is
              required. This fee is non-refundable and includes:
            </p>
            <ul className="list-disc px-10 space-y-4">
              <li>
                <b>Job Posting Features:</b> Access to post job openings, review
                applications, and manage the recruitment process.
              </li>
              <li>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <ul className="list-disc px-10 space-y-4">
              <li>
                <b>Monitoring Account Activity:</b> Regularly check your account
                for updates, notifications, and messages.
              </li>
              <li>
          ...
          <div className="space-y-6">
            ...
            <ul className="list-disc px-10 space-y-4">
              <li>
                <b>Use Strong Passwords:</b> Create a unique and secure password
                for your account.
              </li>
              <li>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <p>
              JobBoost reserves the right to terminate accounts if users violate
              Terms and Conditions, engage in fraudulent activities, or fail to
              comply with platform guidelines. Reasons for account termination
              include:
            </p>
            <ul className="list-disc px-10 space-y-4">
              <li>
              ...
              <li>
                <b>Inactivity:</b> Prolonged periods of inactivity or failure to
                update information.
              </li>
            </ul>
          </div>
