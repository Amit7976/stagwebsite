...
<p>Effective communication is essential for addressing any questions, concerns, or feedback related to our Cookies Policy. This section provides detailed information on how to contact JobBoost, our contact details, and how users can provide feedback and suggestions.</p>
...
<li><b>Email Address:</b> You can send your inquiries to support@jobboost.in.</li>
...
<ul className="list-disc px-10 space-y-4">
<li><b>Contact Form:</b> Available at JobBoost Contact Form.</li>
...
<ul className="list-disc px-10 space-y-4">
<li><b>Office Address:</b> JobBoost Pvt. Ltd., [Office Address], [City], [State], [PIN Code], India.</li>
...
<ul className="list-disc px-10 space-y-4">
<li><b>Email Address:</b> support@jobboost.in</li>
...
<ul className="list-disc px-10 space-y-4">
<li><b>Contact Form:</b> JobBoost Contact Form</li>
...
<ul className="list-disc px-10 space-y-4">
<li><b>Feedback Email:</b> Send your feedback to feedback@jobboost.in.</li>
<ul className="list-disc px-10 space-y-4">
...
<ul className="list-disc px-10 space-y-4">
<li><b>Feedback Form:</b> Available at JobBoost Feedback Form.</li>
...
<ul className="list-disc px-10 space-y-4">
<li><b>Suggestions Email:</b> Send your suggestions to suggestions@jobboost.in.</li>
<ul className="list-disc px-10 space-y-4">
...
<ul className="list-disc px-10 space-y-4">
<li><b>Purpose:</b> Provide constructive feedback or propose new features for JobBoost.</li>
...
<ul className="list-disc px-10 space-y-4">
<li><b>Issue Reporting Email:</b> Report issues to issues@jobboost.in.</li>
<ul className="list-disc px-10 space-y-4">
