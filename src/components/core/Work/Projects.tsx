    ...
    <>
      <section className="px-4 md:px-10">
        <div className="text-left mb-14">
          ...
          <Button
            variant={"ghost"}
            className="rounded-full bg-orange-600 p-1 h-auto pl-8 text-base gap-2 text-white"
          >
            Get A Quote{" "}
            <span>
              <FaArrowRight className="size-10 bg-white rounded-full text-orange-600 p-2 -rotate-45" />
            </span>{" "}
          </Button>
        </div>
        <div className="relative z-10 mt-8 grid grid-cols-1 gap-6 md:grid-cols-5">
          ...
          <div className="bg-gray-100 dark:bg-neutral-900 border-gray-200 dark:border-neutral-800 text-card-foreground rounded-xl border-2 col-span-1 shadow-xl flex flex-col pl-6 py-6 overflow-hidden md:col-span-3 md:flex-row gap-6 md:gap-12">
            <div className="flex-1 flex flex-col justify-between">
              <h4 className="font-semibold text-3xl">
                Geo Radius News <br /> Application
              </h4>
              ...
              <p className="text-muted-foreground mt-3 text-base leading-snug font-medium">
                Geo Radius News is more than just a news platform; it gives
                voice to local people and makes sure people in power notice and
                make required changes. Real-time reporting and verifications
                keep people informed, and inaccurate info is filtered easily.
                From sudden road closures to lost pets or emergency alerts - the
                app ensures vital information reaches those who need it most,
          ...
          <div className="bg-gray-100 dark:bg-neutral-900 border-gray-200 dark:border-neutral-800 text-card-foreground gap-6 rounded-xl border-2 py-6 col-span-1 shadow-xl md:col-span-2 flex flex-col justify-center">
            <div className="px-6">
              ...
              <p className="text-muted-foreground mt-3 text-base leading-snug font-medium">
                Led the design and development of catererss.com. Role: Lead
                Developer. Worked closely with the owner to create a dynamic
                site. Achieved a 30% traffic increase in the first month.
                Positive feedback on UX and design.
              </p>
              <Link
          ...
          <div className="bg-gray-100 dark:bg-neutral-900 border-gray-200 dark:border-neutral-800 text-card-foreground flex flex-col gap-6 rounded-xl border-2 py-6 col-span-1 shadow-xl md:col-span-2">
            <div className="px-6">
              ...
              <p className="text-muted-foreground mt-3 text-base leading-snug font-medium">
                This chat app works without Socket.io/WebSocket, making it
                efficient and scalable. Stores chat data locally for offline
                access. Unique random matching connects users instantly.
          ...
          <div className="bg-gray-100 dark:bg-neutral-900 border-gray-200 dark:border-neutral-800 text-card-foreground flex flex-col gap-6 rounded-xl border-2 p-6 pb-0 col-span-1 shadow-xl overflow-hidden md:col-span-3">
            <div className="px-0">
              ...
              <p className="text-muted-foreground mt-3 text-base leading-snug font-medium">
                Personalized, day-wise learning roadmaps for any topic. No
                login, free, and instant. Generate structured plans, track
                progress, export roadmap - no nonsense, just learning.
              </p>
              <Link
