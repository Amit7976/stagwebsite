...
<p>When you visit a website like JobBoost, your browser requests content from the website’s server. If the page includes content from another domain, such as an advertisement or a social media plugin, that external domain can set its own cookies on your device. These cookies are known as third-party cookies because they are managed by a third party, not the website you are directly visiting.</p>
...
<div className="space-y-6">
<h4 className="font-bold text-2xl text-gray-800 mt-12">3.2. How Does JobBoost Use Third-Party Cookies?</h4>
<p><b>Advertising and Marketing</b></p>
<p>At JobBoost, we use third-party cookies to manage and optimize our advertising efforts. These cookies help us deliver relevant ads to users based on their interests and browsing behavior.</p>
<ul className="list-disc px-10 space-y-4">
<li><b>Targeted Advertising:</b> Third-party advertising cookies track your interactions with our site and other sites you visit. This data is used to serve targeted ads for JobBoost’s job postings, company registrations, and other services. For example, if you view job listings on JobBoost, you might see ads for JobBoost on other websites or platforms.</li>
...
<li><b>Retargeting:</b> Retargeting cookies are used to reach users who have previously visited JobBoost but did not complete a desired action, such as applying for a job or registering a company. These cookies help us display follow-up ads to encourage users to return and complete their application or registration.</li>
</ul>
...
<ul className="list-disc px-10 space-y-4">
<li><b>Social Sharing:</b> Social media cookies enable features like sharing JobBoost job postings on your social media profiles or logging in using social media accounts. These cookies track interactions with social media widgets and provide data to the social media platforms.</li>
<li><b>Social Media Tracking:</b> These cookies also track your engagement with social media content related to JobBoost. For example, they help us see how often our job listings or company updates are shared or liked.</li>
</ul>
</div>
<div className="space-y-6">
...
<p>Managing third-party cookies may affect your experience on JobBoost’s website and other sites you visit. For example, disabling third-party cookies may result in less relevant advertisements or the inability to use certain social media features.</p>
<ul className="list-disc px-10 space-y-4">
