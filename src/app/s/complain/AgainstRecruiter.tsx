  ...
  return (
    <>
      ...
      <div className="space-y-12 mt-20">
        ...
        <div className="grid grid-cols-12 gap-10">
          <div className="space-y-4 col-span-5">
            <label htmlFor="recruiterName" className="text-base font-medium">
              Recruiter’s Name
            </label>
            <Input
              type="text"
          ...
          <div className="space-y-4 col-span-4">
            <label htmlFor="recruiterEmail" className="text-base font-medium">
            ...
            <Input
              ...
              id="RecruiterEmail"
              className="w-full rounded-xl border-2 border-black h-16 text-base px-10 font-medium lowercase placeholder:capitalize"
              placeholder="Recruiter’s Email (Optional)"
              spellCheck="false"
            />
          </div>
          <div className="space-y-4 col-span-3">
        ...
        <div className="grid grid-cols-12 gap-10">
          <div className="space-y-4 col-span-7">
            <label htmlFor="jobPostLink" className="text-base font-medium">
        ...
        <div className="pt-6">
          ...
          <p className="text-base font-medium mt-2 text-gray-500">
            ...
            all positive and negative reviews of the Recruiter. This information
        ...
        <div className="pt-6">
          <h6 className="text-xl font-medium">Complaint Category</h6>
          <p className="text-base font-medium mt-2 text-gray-500">
            Select the category that best describes your complaint. This helps
            us in categorizing and processing your complaint efficiently.
          </p>
          <div className="mt-6">
            <ToggleGroup type="single">
              <ToggleGroupItem
                value="Unprofessional Behavior"
                aria-label="Toggle Unprofessional Behavior"
                className="flex-shrink-0 bg-transparent border-2 border-[#FD500A] rounded-full px-14 py-3.5 h-auto font-medium"
              >
                <span>Unprofessional Behavior</span>
              </ToggleGroupItem>
              <ToggleGroupItem
                value="Misleading Information"
                aria-label="Toggle Misleading Information"
                className="flex-shrink-0 bg-transparent border-2 border-[#FD500A] rounded-full px-14 py-3.5 h-auto font-medium"
              >
              ...
              <ToggleGroupItem
                ...
                aria-label="Toggle Discrimination"
                className="flex-shrink-0 bg-transparent border-2 border-[#FD500A] rounded-full px-14 py-3.5 h-auto font-medium"
              >
...
export default AgainstRecruiter;
