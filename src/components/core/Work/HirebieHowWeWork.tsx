      ...
      <div className="px-4 md:px-10">
        <div className="mb-14 px-5 text-center w-full">
          <h2 className="text-3xl md:text-6xl font-medium">
            Process of <span className="text-orange-600 font-bold">Growth</span>
          </h2>
        </div>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <p className="text-base md:text-xl lg:font-medium text-muted-foreground">
                    Before we start building anything, we dive deep to
                    understand your business from every angle, your goals,
                    target audience, industry trends, and your unique
                    challenges. This discovery phase helps us uncover real
                    opportunities and align our strategy with your long-term
                    vision, so we lay a rock-solid foundation for everything
                    that follows.
                  </p>
                </div>
              </div>
