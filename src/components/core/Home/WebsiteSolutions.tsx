          ...
          {services.map((service, idx) => (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center sm:gap-2">
                <div className="w-10 h-10 sm:w-auto sm:h-auto flex items-center scale-150 sm:scale-100 ml-2.5 sm:ml-0">
                  {" "}
                  {service.icon}
                </div>
                <div className="flex items-center justify-start gap-1">
                  <p className="text-[4vw] sm:text-[2.5vw] lg:text-[1.1vw] font-medium">
                    {service.title}
                  </p>
                  <ChevronRight className="size-5 md:size-4 shrink-0 transition-transform md:group-hover:translate-x-0.5" />
                </div>
              </div>
              <p className="text-[3.5vw] sm:text-[2vw] lg:text-[1vw] text-muted-foreground">
                {service.desc}
              </p>
            </a>
          ))}
