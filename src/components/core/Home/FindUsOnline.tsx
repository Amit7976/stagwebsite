      ...
      <div className="lg:px-10 flex flex-col items-center justify-center">
        ...
        <div className="mb-10 grid w-full gap-6 grid-cols-3">
          {socials.map((social, index) => (
            <div key={index}>
              <div className="group flex-1 flex-col items-center gap-2 rounded-2xl border-0 bg-background p-8 transition-colors duration-200 hover:bg-muted hidden md:flex">
