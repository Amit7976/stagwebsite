    ...
    return (
        <>
            <section className="px-10">
                <div className="mb-12 flex items-center gap-10 px-5">
                ...
                <div className="mt-12 mb-6 flex flex-col gap-6 xl:flex-row">
                    ...
                    {/* <!-- Card 1 --> */}
                    <div className="flex w-full flex-col justify-between overflow-hidden rounded-2xl border-2 bg-gray-100 dark:bg-neutral-900 border-gray-200 dark:border-neutral-800 px-12 pt-10 text-card-foreground shadow-sm">
                        ...
                        <Image width={600} height={600} src="/images/work/customSolution.jpg" alt="Custom Solutions" className="max-h-52 w-full rounded-t-md object-cover shadow-[0_0_10px_rgb(0,0,0,0.2)]" />
                    </div>
                    ...
                    <div className="w-full overflow-hidden rounded-2xl border-2 bg-gray-100 dark:bg-neutral-900 border-gray-200 dark:border-neutral-800 text-card-foreground shadow-sm">
                        <div className="pr-12 pl-12 xl:pl-0">
                            <Image width={600} height={600} src="/images/work/support.jpg" alt="Partnership" className="max-h-48 w-full rounded-br-md object-cover shadow-[0_0_10px_rgb(0,0,0,0.2)]" />
                        </div>
                        <div className="flex flex-2 w-full flex-col p-10 md:gap-3">
                ...
                <div className="flex w-full flex-col items-center justify-center gap-6 overflow-hidden rounded-2xl border-2 bg-gray-100 dark:bg-neutral-900 border-gray-200 dark:border-neutral-800 text-card-foreground shadow-sm md:flex-row">
                    <div className="flex flex-col gap-3 p-10 flex-3">
