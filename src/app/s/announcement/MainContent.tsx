        ...
        <section>
          <div className="w-full">
            ...
            <p className="mt-4 text-lg font-medium text-neutral-500 text-balance">
              Welcome to the Announcement Center. Stay up-to-date with all the
              latest news and updates from JobBoost. Whether it&#39;s new
              features, maintenance alerts, or special offers, you’ll find
          ...
          <div className="grid lg:grid-cols-1 lg:gap-y-16 gap-10">
            {announcementLoading ? (
              ...
              announcements.map((announcement, index) => (
                <div
                  key={index}
                  className="group rounded-xl overflow-hidden hover:border-gray-200 border-2 duration-500 p-2"
                >
                  <div className="sm:flex">
                    {announcement.image && (
                      <div className="flex-shrink-0 relative rounded-xl overflow-hidden w-full sm:w-56 aspect-video">
                        <Image
                          className="group-hover:scale-105 transition-transform duration-500 ease-in-out size-full absolute top-0 start-0 object-cover object-top rounded-xl"
                        ...
                        <div className="mt-6">
                          {announcement.link ? (
                            <Link
                              ...
                              className="inline-flex items-center gap-x-1 text-orange-600 decoration-2 hover:underline font-medium"
                            >
                              View Details
                              <svg
