  ...
  return (
    <>
      <section className="relative md:h-svh max-h-[1400px] md:min-h-[600px] w-full bg-[url('/images/Home/abstract_light.png')] dark:bg-[url('/images/Home/abstract_dark.jpg')] bg-cover bg-center bg-no-repeat">
        <div className="relative z-10 mx-auto flex size-full max-w-[125rem] px-4 py-9 pt-40 md:pt-60 overflow-hidden">
          <div className="flex w-full flex-col justify-between gap-10">
            <div className="flex flex-col items-center justify-center gap-7 mx-auto sm:max-w-[37.5rem] md:max-w-[50rem] z-10">
              <HomeHeroHeading />

              <p className="md:text-balance text-center text-lg md:text-2xl text-neutral-700 dark:text-neutral-400 font-medium font-sans2">
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                <LoaderLink
                  href="/s/contact"
                  className="flex items-center rounded-full bg-orange-600 p-1 h-auto pl-8 text-base gap-2 hover:bg-orange-700 text-white"
                >
                  Get A Quote{" "}
                  <span>
