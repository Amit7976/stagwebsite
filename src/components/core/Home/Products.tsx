...
function Products() {
  ...
  useEffect(() => {
    ...
    sections.forEach((section: Element) => {
      const leftPart = section.querySelector(
        ".from-left",
      ) as HTMLElement | null;
      const rightPart = section.querySelector(
        ".from-right",
      ) as HTMLElement | null;
      ...
      if (rightPart) {
        ...
        const bodyElsRight = rightPart.querySelectorAll(
          "p, ul",
        ...
        const bodyElsLeft = leftPart?.querySelectorAll(
          "p, ul",
        ) as NodeListOf<HTMLElement>;
              ...
              <div className="from-right lg:flex lg:w-1/2 lg:items-center lg:pl-24 2xl:pl-32">
                <div>
                  ...
                  <p className="font-medium text-muted-foreground font-sans2 text-lg mb-3">
                    Our comprehensive IT solutions help you navigate the digital
                    landscape with confidence. We ensure your business stays
                    secure, scalable, and future-ready with services tailored to
                    your specific needs.
                  </p>
            ...
            <div className="reveal-section flex-row-reverse lg:flex lg:gap-x-4">
              ...
              <div className="from-left lg:flex lg:w-1/2 lg:items-center lg:pr-24 2xl:pr-32">
                <div>
                  ...
                  <p className="font-medium text-muted-foreground font-sans2 text-lg mb-3">
                    Build a brand that speaks for itself. We transform your
                    vision into a compelling identity that captures your
                    audience’s trust and sets you apart from competitors.
                  </p>
                  <ul className="list-disc text-muted-foreground font-sans2 text-lg space-y-2">
            ...
            <div className="reveal-section lg:flex lg:gap-x-4">
              ...
              <div className="from-right lg:flex lg:w-1/2 lg:items-center lg:pl-24 2xl:pl-32">
                <div>
                  ...
                  <p className="font-medium text-muted-foreground font-sans2 text-lg mb-3">
                    Our internship program bridges the gap between academics and
                    industry experience. We empower fresh talent with real-world
                    projects, practical training, and career growth.
                  </p>
                  <ul className="list-disc text-muted-foreground font-sans2 text-lg space-y-2">
